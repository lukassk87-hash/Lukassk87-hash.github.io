  ...
  <div class="container">
    ...
    <section id="deutsch" class="language-section active" lang="de">
      ...
      <p>
        ...
        wie Geräte-ID oder Installationsinformationen erheben. Details dazu finden
        Sie in den jeweiligen Datenschutzhinweisen der Anbieter.
      </p>

      <h3>4. Ihre Rechte</h3>
      <p>
        Trotz fehlender Datenverarbeitung haben Sie gemäß DSGVO Rechte wie
        Auskunft, Löschung oder Beschwerde bei der zuständigen Datenschutzaufsichtsbehörde.
      </p>
    ...
    <section id="english" class="language-section" lang="en">
      ...
      <p>
        ...
        such as device identifiers or installation information. Please refer to
        their respective privacy policies for details.
      </p>

      <h3>4. Your rights</h3>
      <p>
        Even though no personal data is processed, you have rights under the GDPR,
        including the right to access, deletion, or to lodge a complaint with the
    ...
    <section id="espanol" class="language-section" lang="es">
      ...
      <p>
        ...
        o Apple pueden recopilar metadatos como identificadores del dispositivo o
        información sobre la instalación. Consulte sus respectivas políticas de
        privacidad para más detalles.
      </p>

      <h3>4. Sus derechos</h3>
      <p>
        Aunque no se procesen datos personales, usted tiene derechos conforme al RGPD,
        como el derecho de acceso, supresión o a presentar una reclamación ante la
